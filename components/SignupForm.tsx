  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3" noValidate>
      ...
      <button
        type="submit"
        disabled={!canSubmit}
        className="w-full bg-gold text-ink font-sans font-bold text-base py-3 px-6 rounded text-center hover:bg-gold-light transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed mt-1"
      >
